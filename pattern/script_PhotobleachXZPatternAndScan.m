...
%% Execution [1/3] - Perform Low-Resolution Surface Identification Scans

fprintf('%s [1/3] Performing Low-Resolution Surface Identification Scans...\n', datestr(datetime));
...
fprintf('%s [1/3] Surface Identification scans completed successfully.\n', datestr(datetime));


%% Execution [2/3] - Perform Main OCT Scan

% Assert with new function here once that's committed and functional

% Perform the OCT Scan
volumeOutputFolder = [output_folder '/OCTVolume/'];
fprintf('%s [2/3] Performing Main OCT Scan...\n', datestr(datetime));
...
yOCTProcessTiledScan(...
    ...
    'interpMethod','sinc5', ...
    'v',true);
fprintf("[2/3] OCT Scan completed successfully.\n");


%% Execution [3/3] Photobleach XZ Pattern

fprintf('%s [3/3] Starting Photobleaching XZ Pattern\n', datestr(datetime));
yOCTPhotobleachTile(...
